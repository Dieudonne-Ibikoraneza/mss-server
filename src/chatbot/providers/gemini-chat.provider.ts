...
- Only return product picks when the per-turn instruction explicitly says NEW RECOMMENDATIONS ARE REQUESTED. Having enough room information by itself is never a reason to recommend again.
        ...
        parts: [
          {
            text:
              ...
              (input.allowRecommendations
                ? 'Per-turn instruction: NEW RECOMMENDATIONS ARE REQUESTED. You may return picks if the brief is sufficient.\n\n'
                : 'Per-turn instruction: THIS IS NOT A REQUEST FOR NEW RECOMMENDATIONS. You MUST return an empty picks array and answer conversationally using prior context.\n\n') +
